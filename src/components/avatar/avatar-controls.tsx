...
import { SidebarHeader, SidebarContent, SidebarMenu, SidebarMenuItem, SidebarMenuButton, SidebarTrigger } from "@/src/components/ui/sidebar";
    ...
    <>
      <SidebarHeader className="flex items-center justify-between p-3">
        <div className="flex items-center gap-2">
            <svg role="img" aria-label="3D Avatar Chat" width="28" height="28" viewBox="0 0 24 24" fill="currentColor" className="text-foreground" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="font-semibold text-lg text-foreground">3D Avatar</span>
        </div>
        <SidebarTrigger />
      </SidebarHeader>
      <SidebarContent className="p-3">
        ...
        <SidebarMenu className="mt-4">
          ...
          <SidebarMenuItem>
           ...
           <SidebarMenuItem>
            <SidebarMenuButton tooltip="Join Video Chat">
              <Radio />
